...
public class TestContext {
	...
	private static final String CONTENT_TYPE = ConfigReader.getProperty("content.type");
	...
	public RequestSpecification requestSetup() {
		...
		return RestAssured.given().config(config).filter(new RequestFilter()).contentType(CONTENT_TYPE)
				.accept(CONTENT_TYPE);
	}
}
